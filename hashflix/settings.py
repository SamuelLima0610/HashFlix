...
SECRET_KEY = 'django-insecure-sayq^(f4fk=(tf@tx%f%e+hn=h-oc$(mrkmpynz4*1knkxy-5!'
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'https://hashflixpy.herokuapp.com'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'movie.context.lista_filmes_recentes',
                'movie.context.lista_filmes_em_alta',
            ],
        },
    },
]
